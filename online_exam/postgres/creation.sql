...
CREATE TABLE subjects (
    ...
    subject_code   VARCHAR(10)  NOT NULL UNIQUE,      -- Added UNIQUE constraint
...
CREATE TABLE classes (
    ...
    class_name     VARCHAR(50) NOT NULL,          -- e.g., "Grade 8", "Form 3"
    date_created   TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    date_modified  TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
...
CREATE TABLE choices (
    ...
    choice_label      VARCHAR(5)   NOT NULL,         -- e.g., A, B, C
